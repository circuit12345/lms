...
class __Mustache_34a74615791917125e4d7da6ceb5d813 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<style>
';
        $buffer .= $indent . '/* Animate dropdown fade and slide */
';
        $buffer .= $indent . '@keyframes fadeSlideDown {
';
        $buffer .= $indent . '    0% {
';
        $buffer .= $indent . '        opacity: 0;
';
        $buffer .= $indent . '        transform: translateY(-10px);
';
        $buffer .= $indent . '    }
';
        $buffer .= $indent . '    100% {
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '/* Animate user menu toggle button */
';
        $buffer .= $indent . '.btn.dropdown-toggle {
';
        $buffer .= $indent . '    transition: transform 0.3s ease;
';
        $buffer .= $indent . '}
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '.btn.dropdown-toggle:focus,
';
        $buffer .= $indent . '.btn.dropdown-toggle:hover {
';
        $buffer .= $indent . '    transform: scale(1.05);
';
        $buffer .= $indent . '    box-shadow: 0 0 8px rgba(0, 204, 153, 0.7);
';
        $buffer .= $indent . '}
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '/* Animate dropdown menu */
';
        $buffer .= $indent . '.dropdown-menu {
';
        $buffer .= $indent . '    animation: fadeSlideDown 300ms ease forwards;
';
        $buffer .= $indent . '    transform-origin: top center;
';
        $buffer .= $indent . '    opacity: 0; /* start invisible, fadeSlideDown animates visible */
';
        $buffer .= $indent . '}
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '/* Smooth carousel submenu transitions */
';
        $buffer .= $indent . '.carousel-item.submenu {
';
        $buffer .= $indent . '    transition: opacity 0.5s ease, transform 0.5s ease;
';
        $buffer .= $indent . '}
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '/* Menu item hover effect */
';
        $buffer .= $indent . '.dropdown-item:hover {
';
        $buffer .= $indent . '    background-color: #00cc99;
';
        $buffer .= $indent . '    color: white !important;
';
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '/* Header and items styling */
';
        $buffer .= $indent . '.usermenu .dropdown-toggle .userbutton {
';
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '/* Submenu header back button hover effect */
';
        $buffer .= $indent . '.header button.btn-icon:hover {
';
        $buffer .= $indent . '    color: #00cc99;
';
...
';
            $buffer .= $indent . '            </a>
';
            $buffer .= $indent . '            <div id="user-action-menu" class="dropdown-menu dropdown-menu-end shadow-lg rounded-lg p-3">
';
...
';
            ...
            $buffer .= '">
';
            $buffer .= $indent . '                            <a id="accessibilitysettings-control" href="#" class="dropdown-item fw-semibold" role="menuitem" tabindex="-1" aria-label="';
            $value = $context->find('str');
            $buffer .= $this->section924904c6b8e7067ba36e81c6984a52c3($context, $indent, $value);
            $buffer .= '">
';
            $buffer .= $indent . '                                ';
            $value = $context->find('str');
...
';
            ...
            $buffer .= $this->section10f45a13279d7a689b7a6712333e062f($context, $indent, $value);
            $buffer .= $indent . '                    </div>
';
            $buffer .= $indent . '                </div>
';
...
';
        ...
        $buffer .= $this->section2675fa5603e623bce6863c4ce5c5ddb9($context, $indent, $value);
...
';
    ...
    private function section924904c6b8e7067ba36e81c6984a52c3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = 'themesettings:accessibility, theme_moove';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
        } elseif (!empty($value)) {
            $values = $this->isIterable($value) ? $value : array($value);
            foreach ($values as $value) {
                ...
                $buffer .= 'themesettings:accessibility, theme_moove';
                $context->pop();
            }
        }
    ...
    private function section10f45a13279d7a689b7a6712333e062f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
                            ...
                            <div id="carousel-item-{{id}}" role="menu" class="carousel-item submenu" tabindex="-1" aria-label="{{title}}">
                                <div class="d-flex flex-column h-100">
                                    <div class="header d-flex align-items-center mb-3">
                                        ...
                                        <span class="ps-2 fw-bold fs-5" id="carousel-item-title-{{id}}">{{title}}</span>
                                    </div>
...
';
                $buffer .= $indent . '                                    <div class="header d-flex align-items-center mb-3">
';
...
';
                $buffer .= $indent . '                                        <span class="ps-2 fw-bold fs-5" id="carousel-item-title-';
                $value = $this->resolveValue($context->find('id'), $context);
                $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
                $buffer .= '">';
                $value = $this->resolveValue($context->find('title'), $context);
...
';
    ...
    private function section2675fa5603e623bce6863c4ce5c5ddb9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '    require([\'core/usermenu\', \'theme_moove/accessibilitysettings\'], function(UserMenu, AccessibilitySettings) {
';
                $buffer .= $indent . '        UserMenu.init();
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '        AccessibilitySettings.init();
';
                $buffer .= $indent . '    });
';
                $context->pop();
