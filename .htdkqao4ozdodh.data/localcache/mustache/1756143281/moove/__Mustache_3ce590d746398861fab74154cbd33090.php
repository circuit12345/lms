...
class __Mustache_3ce590d746398861fab74154cbd33090 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section0ae7b1554ef48aff39c4886787d8a68e($context, $indent, $value);
        $value = $context->find('jobs');
        if (empty($value)) {
...
';
    ...
    private function section0ae7b1554ef48aff39c4886787d8a68e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
