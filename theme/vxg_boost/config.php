...
$THEME->scss = function($theme) {
    return theme_vxg_boost_get_main_scss_content($theme);
};

$THEME->prescsscallback = 'theme_vxg_boost_get_pre_scss';
$THEME->extrascsscallback = 'theme_vxg_boost_get_extra_scss';
